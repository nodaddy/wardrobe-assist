...
import { FacebookOutlined, GoogleOutlined, InstagramOutlined, Loading3QuartersOutlined, XOutlined } from '@ant-design/icons';
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          &nbsp;
            &nbsp;
            <span style={{cursor: 'pointer', color: 'grey', fontSize: '23px'}}><InstagramOutlined /></span>
            &nbsp;
            &nbsp;
            <span style={{cursor: 'pointer', color: 'grey', fontSize: '23px'}}><XOutlined /></span>
            &nbsp;
            &nbsp;
            <span style={{cursor: 'pointer', color: 'grey', fontSize: '23px'}}><FacebookOutlined /></span>
            &nbsp;
            &nbsp;
            &nbsp;
        </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ fontStyle: 'italic', color: '#555' }}>
                  "Oh this app! It's like totally ending my indecisiveness around what to wear and what to buy next to complement my wardrobe, good investement for personality improvement"
                </p>
